...
function out_epg($id,$is_simple) {
	if(mb_substr($id,mb_strlen($id,'utf8mb4')-2,mb_strlen($id,'utf8mb4'),'utf8mb4') == '高清' || mb_substr($id,mb_strlen($id,'utf8mb4')-2,mb_strlen($id,'utf8mb4'),'utf8mb4') == '标清') {
		$id = mb_substr($id,0,-2,'utf8mb4');
