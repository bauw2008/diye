					...
					<div class="form-group">
						<form method="POST" style="padding: 20px">
							<table class="table table-hover">
								...
								<tbody>
									<?php
									$result=$db->mQuery("select name,author,useradmin,ipcheck,epgadmin,mealsadmin,movieadmin,channeladmin from itv_admin");
									while ($row=mysqli_fetch_array($result)) {
										...
										if($movieadmin==1){
											$movieadminchecked=" checked='true'";
										}else{
											$movieadminchecked="";
										}
										if($channeladmin==1){
