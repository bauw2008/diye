                				...
                				<div class="table-responsive">
									<table class="table table-hover">
										...
										<tr>
											...
											<th class="w-5"><a href="?order=meal">套餐</a></th>
											<th class="w-5"><a href="?order=mac">MAC地址</a></th>
											<th class="w-5"><a href="?order=deviceid">设备ID</a></th>
											<th class="w-10"><a href="?order=model">型号</a></th>
											<th class="w-15"><a href="?order=ip">IP</a></th>
											<th class="w-15"><a href="?order=region">地区</a></th>
											<th class="w-10"><a href="?order=lasttime">最后登陆</a></th>
											<th class="w-5"><a href="?order=exp">状态</a></th>
											<th class="w-5"><a href="?order=author">授权人</a></th>
											<th class="w-5"><a href="?order=marks">备注</a></th>
										</tr>
										</thead>
										<tbody>
											<form method="POST">
												<?php
													...
													if($user=='admin'){
													$func="select status,name,mac,deviceid,model,ip,region,lasttime,exp,author,marks,vpn,meal from itv_users where status>0 $searchparam order by $order limit $recStart,$recCounts";
													}else{
														$func="select status,name,mac,deviceid,model,ip,region,lasttime,exp,author,marks,vpn,meal from itv_users where status>0 and author='$user' $searchparam order by $order limit $recStart,$recCounts";
													}
													$meals=$db->mQuery("select id,name from itv_meals");
													...
													<td colspan="12">
														<div class="input-group">
															<div class="input-group-btn">
																...
																<button class="btn btn-sm btn-primary m-r-10" type="submit" name="submitclear">设备解绑</button>
