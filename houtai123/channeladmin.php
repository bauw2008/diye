            			...
            			<div class="card-body">
							...
							<td align="center" valign="top" style="float: left;padding: 40px 0 0 0;border-width: 0px;height: 800px;overflow:auto;">
								...
								<div class="btn-group-vertical" style="padding-left: 15px;">
									...
									<?php
										if ($categorytype=='vip'){
											$func = "SELECT name,psw,enable FROM itv_category where type='$categorytype' order by id";
										}else{
											$func = "SELECT name,psw,enable FROM itv_category where type='$categorytype' or type='thirdlist' order by id";
										}
