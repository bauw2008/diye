<?php
//decode by http://www.cnkr.vip.com/
				...
				<nav class="sidebar-main">
					<ul class="nav nav-drawer">
						...
						if (strpos($_SERVER['REQUEST_URI'],'index.php') !== false){
							...
							$useradmin='active';
						} else if (strpos($_SERVER['REQUEST_URI'],'useradmin01.php') !== false){
							$useradmin01='active';
							...
							$ordersadmin='active';
						} else if (strpos($_SERVER['REQUEST_URI'],'movie.php') !== false){
							$movie='active';
						...
						?>
						<li class="nav-item <?php echo $index ?>"> <a href="index.php"><i class="mdi mdi-home"></i>后台首页</a> </li>
						<li class="nav-item <?php echo $author ?>"> <a href="author.php"><i class="mdi mdi-account-check"></i>授权管理</a> </li>
						<li class="nav-item <?php echo $useradmin ?>"> <a href="useradmin.php"><i class="mdi mdi-account"></i>用户管理</a> </li>
						<li class="nav-item <?php echo $mealsadmin ?>"> <a href="mealsadmin.php"><i class="mdi mdi-shopping"></i>套餐管理</a></li>
						<li class="<?php echo $default ?>"><a href="channeladmin.php?type=default"><i class="mdi mdi-television-classic"></i>频道列表</a></li>
						<li class="nav-item nav-item-has-subnav sysadmin">
							...
							<ul class="nav nav-subnav">
								...
								<li class="<?php echo $index6 ?>"><a href="sysadmin.php?index=6">EPG和UA</a></li>
			...
			<nav class="navbar navbar-default">
				<div class="topbar">
					<div class="topbar-left">
						...
						<?php
						if (strpos($_SERVER['REQUEST_URI'],'index.php') !== false){ echo '&nbsp;后台首页&nbsp;'; }
						else if (strpos($_SERVER['REQUEST_URI'],'author.php') !== false){ echo '&nbsp;授权管理&nbsp;'; }
						else if (strpos($_SERVER['REQUEST_URI'],'useradmin01.php') !== false){ echo '&nbsp;账号管理&nbsp;'; }
						else if (strpos($_SERVER['REQUEST_URI'],'useradmin.php') !== false){ echo '&nbsp;用户管理&nbsp;'; }
						else if (strpos($_SERVER['REQUEST_URI'],'exception.php') !== false){ echo '&nbsp;异常列表&nbsp;'; }
						else if (strpos($_SERVER['REQUEST_URI'],'mealsadmin.php') !== false){ echo '&nbsp;套餐管理&nbsp;'; }
						else if (strpos($_SERVER['REQUEST_URI'],'ordersadmin.php') !== false){ echo '&nbsp;订单管理&nbsp;'; }
						else if (strpos($_SERVER['REQUEST_URI'],'epgadmin.php') !== false){ echo '&nbsp;EPG管理&nbsp;'; }
						else if (strpos($_SERVER['REQUEST_URI'],'movie.php') !== false){ echo '&nbsp;点播管理&nbsp;'; }
