<?php require_once "apps/userloginController.php";require_once "houtai123/view.main.php"; ?>
		...
		<div class="lyear-login">
			...
			<div class="login-center form__content">
				<div class="login-header text-center">
					<a href="houtai123.php"> <img alt="light year admin" src="houtai123/images/logo-sidebar.png"> </a>
				</div>
				...
				<footer class="col-sm-12 text-center">
					<p class="m-b-0">Copyright © 2020 <a>加入TV交流群</a>. All right reserved</p>
				</footer>
			</div>
		</div>
	</div>
